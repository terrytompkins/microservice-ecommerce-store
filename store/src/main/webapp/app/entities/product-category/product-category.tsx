      ...
      <h2 id="product-category-heading" data-cy="ProductCategoryHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="storeApp.productCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="storeApp.productCategory.id">ID</Translate>
                </th>
                <th>
