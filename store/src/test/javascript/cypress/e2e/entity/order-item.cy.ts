...
describe('OrderItem e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/products',
      body: {"name":"infrastructures","description":"background Baby","price":50830,"productSize":"XXL","image":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","imageContentType":"unknown"},
    }).then(({ body }) => {
      product = body;
    });
    // create an instance at the required relationship entity:
    cy.authenticatedRequest({
      ...
      body: {"placedDate":"2022-12-12T12:33:41.469Z","status":"PENDING","code":"salmon Junctions","invoiceId":55261},
    }).then(({ body }) => {
      productOrder = body;
    });
  });
