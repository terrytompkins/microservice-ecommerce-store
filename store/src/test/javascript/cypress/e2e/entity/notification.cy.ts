...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-12-12T11:28:38.457Z',
    sentDate: '2022-12-12T11:55:41.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-12-11T18:57').blur().should('have.value', '2022-12-11T18:57');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2022-12-12T04:36').blur().should('have.value', '2022-12-12T04:36');
