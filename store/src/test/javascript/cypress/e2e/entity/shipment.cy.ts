...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2022-12-11T18:17:37.261Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'robust scale',
        date: '2022-12-12T11:02:38.314Z',
        details: 'withdrawal sensor',
        status: 'PAID',
        paymentMethod: 'CREDIT_CARD',
        paymentDate: '2022-12-11T16:46:38.996Z',
        paymentAmount: 16937,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-12-11T19:43').blur().should('have.value', '2022-12-11T19:43');
