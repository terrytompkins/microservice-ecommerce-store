...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    ...
    date: '2022-12-12T10:27:50.347Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-12-12T13:41:35.969Z',
    paymentAmount: 88901,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-12-12T11:35').blur().should('have.value', '2022-12-12T11:35');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-12-12T03:43').blur().should('have.value', '2022-12-12T03:43');
