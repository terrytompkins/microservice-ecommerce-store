...
describe('ProductOrder e2e test', () => {
  ...
  // const productOrderSample = {"placedDate":"2022-12-12T14:49:44.294Z","status":"CANCELLED","code":"Buckinghamshire"};
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-12-12T09:01').blur().should('have.value', '2022-12-12T09:01');
